...
import DepartmentEventUpload from '@/components/department-event-upload'
        ...
        <div className={`h-full flex flex-col ${sidebarCollapsed ? 'p-4' : 'p-6'}`}>
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-none">
            <nav className="space-y-2 mb-6">
              ...
              <Button 
                variant={activeTab === 'upload-dept-events' ? 'default' : 'ghost'}
                onClick={() => setActiveTab('upload-dept-events')}
                className={`w-full ${sidebarCollapsed ? 'h-12 w-12 p-0 mx-auto' : 'justify-start'} ${activeTab === 'upload-dept-events' ? 'bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700' : 'hover:bg-orange-50 dark:hover:bg-orange-900/20'}`}
                title={sidebarCollapsed ? "Upload Department Events" : ""}
              >
                <Upload className="w-5 h-5" />
                {!sidebarCollapsed && <span className="ml-3">Upload Dept Events</span>}
              </Button>
            </nav>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card className="p-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200 dark:border-blue-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-blue-600 dark:text-blue-400">{departmentStats.totalStudents}</div>
                  ...
                  <Card className="p-3 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-green-600 dark:text-green-400">{departmentStats.totalTeachers}</div>
                  ...
                  <Card className="p-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-purple-600 dark:text-purple-400">{departmentStats.totalClasses}</div>
                  ...
                  <Card className="p-3 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-orange-200 dark:border-orange-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-orange-600 dark:text-orange-400">{departmentStats.totalEvents}</div>
      ...
      <div className={`transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-28' : 'lg:ml-96'} min-h-screen`}>
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-4 lg:py-8">
          ...
          <div className="mb-6 lg:mb-8 pt-16 lg:pt-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">Welcome back, {session?.user?.name || 'Department Admin'}</p>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                  ...
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-blue-700 dark:text-blue-300">{departmentStats.totalStudents.toLocaleString()}</p>
                      </div>
                  ...
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-green-700 dark:text-green-300">{departmentStats.totalTeachers}</p>
                      </div>
                  ...
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-purple-700 dark:text-purple-300">{departmentStats.totalClasses}</p>
                      </div>
                ...
                <Card className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-orange-200 dark:border-orange-800">
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs lg:text-sm font-medium text-orange-600 dark:text-orange-400">Department Events</p>
                        <p className="text-xl lg:text-3xl font-bold text-orange-700 dark:text-orange-300">{departmentStats.totalEvents}</p>
                      </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 border border-cyan-200 dark:border-cyan-800 rounded-lg bg-cyan-50 dark:bg-cyan-900/20">
                      <h3 className="font-semibold text-cyan-900 dark:text-cyan-100 mb-2">Department Events Management</h3>
                      <p className="text-sm text-cyan-700 dark:text-cyan-300 mb-3">Upload and manage department-specific event documents with AI assistance.</p>
                      <Button 
                        onClick={() => setActiveTab('upload-dept-events')}
                        size="sm" 
          ...
          {activeTab === 'upload-dept-events' && (
            <div className="space-y-6">
              <DepartmentEventUpload />
            </div>
          )}

...
import CollegeEventUpload from '@/components/college-event-upload'
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-none">
            <nav className="space-y-2 mb-6">
              ...
              <Button 
                ...
                className={`w-full ${sidebarCollapsed ? 'h-12 w-12 p-0 mx-auto' : 'justify-start'} ${activeTab === 'view-college-events' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700' : 'hover:bg-purple-50 dark:hover:bg-purple-900/20'}`}
              ...
              <Button 
                ...
                className={`w-full ${sidebarCollapsed ? 'h-12 w-12 p-0 mx-auto' : 'justify-start'} ${activeTab === 'view-dept-events' ? 'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700' : 'hover:bg-purple-50 dark:hover:bg-purple-900/20'}`}
              ...
              <Button 
                variant={activeTab === 'upload-college-events' ? 'default' : 'ghost'}
                onClick={() => setActiveTab('upload-college-events')}
                className={`w-full ${sidebarCollapsed ? 'h-12 w-12 p-0 mx-auto' : 'justify-start'} ${activeTab === 'upload-college-events' ? 'bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700' : 'hover:bg-orange-50 dark:hover:bg-orange-900/20'}`}
                title={sidebarCollapsed ? "Upload College Events" : ""}
              >
                <Upload className="w-5 h-5" />
                {!sidebarCollapsed && <span className="ml-3">Upload College Events</span>}
              </Button>
            </nav>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Card className="p-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-purple-600 dark:text-purple-400">{adminStats.totalClasses}</div>
                  ...
                  <Card className="p-3 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border-orange-200 dark:border-orange-800">
                    <div className="text-center">
                      <div className="text-lg font-bold text-orange-600 dark:text-orange-400">{adminStats.totalEvents}</div>
      ...
      <div className={`transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-28' : 'lg:ml-96'} min-h-screen`}>
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-4 lg:py-8">
          ...
          <div className="mb-6 lg:mb-8 pt-16 lg:pt-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">Welcome back, {session?.user?.name || 'Administrator'}</p>
          </div>
                  ...
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-purple-700 dark:text-purple-300">{adminStats.totalClasses}</p>
                      </div>
                  ...
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-orange-700 dark:text-orange-300">{adminStats.totalEvents}</p>
                      </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 border border-blue-200 dark:border-blue-800 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                      <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">College Events View</h3>
                      <p className="text-sm text-blue-700 dark:text-blue-300 mb-3">View and browse college event documents and announcements (read-only access).</p>
                      <Button 
                        onClick={() => setActiveTab('view-college-events')}
                        size="sm" 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div className="p-4 border border-orange-200 dark:border-orange-800 rounded-lg bg-orange-50 dark:bg-orange-900/20">
                      <h3 className="font-semibold text-orange-900 dark:text-orange-100 mb-2">College Events Management</h3>
                      <p className="text-sm text-orange-700 dark:text-orange-300 mb-3">Upload and manage college event documents with AI-powered processing.</p>
                      <Button 
                        onClick={() => setActiveTab('upload-college-events')}
                        size="sm" 
          ...
          {activeTab === 'upload-college-events' && (
            <div className="space-y-6">
              <CollegeEventUpload />
            </div>
          )}
